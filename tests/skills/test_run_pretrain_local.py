...
"""Unit tests for skills/_shared/scripts/run_pretrain_local.py.
...
SCRIPT = REPO_ROOT / "skills" / "_shared" / "scripts" / "run_pretrain_local.py"
...
def test_materialize_ckpt_zeroes_resume_counters(tmp_path: Path) -> None:
    ...
    pretrain_ddp.py."""
    # Use the canonical shared scripts directory and import the helper directly.
    import importlib.util, sys
    spec = importlib.util.spec_from_file_location(
        "run_pretrain_local", REPO_ROOT / "skills" / "_shared" / "scripts" / "run_pretrain_local.py"
    )

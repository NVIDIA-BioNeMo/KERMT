...
"""Unit tests for skills/_shared/scripts/run_inference.py.
...
Run in-container:
    KERMT_IMAGE=kermt:rebuild-test skills/_shared/scripts/kermt_container.sh run -- \\
        "python -m pytest tests/skills/test_run_inference.py -v \\
...
SCRIPT = REPO_ROOT / "skills" / "_shared" / "scripts" / "run_inference.py"
...
PREPARE_DATA_SCRIPT = REPO_ROOT / "skills" / "_shared" / "scripts" / "prepare_data.py"
